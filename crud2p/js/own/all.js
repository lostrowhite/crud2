...
// mini jQuery plugin that formats to two decimal places
    ...
    jQuery( function() {
        jQuery('#montoe').currencyFormat();
		 jQuery('#monto').currencyFormat();
    });

jQuery(document).ready(function(){
  jQuery('#id_d').combogrid({
    panelWidth:700,
 ...
 {field:'id_d',title:'ID_D',width:60},
   {field:'partida',title:'Partida',width:100},
    {field:'nombre',title:'Nombre',width:60}
    ]]
    });
	
jQuery('#id_u').combogrid({
    panelWidth:500,
    url: 'index.php/procesos/unidad',
    idField:'codigo',
    textField:'codigo',
    mode:'remote',
    fitColumns:true,
	required:true,
    columns:[[
 {field:'id_pr',title:'ID',width:60},	
  {field:'nombre',title:'Nombre',width:120},
   {field:'codigo',title:'Codigo',width:60}
    ]],
	  onSelect:function(){
		 var g = jQuery('#id_u').combogrid('grid');	// get datagrid object
		 var r = g.datagrid('getSelected');	// get the selected row
         jQuery('#pr').val(r.id_pr);
    }
    });
jQuery('#id_f').combogrid({
    panelWidth:500,
    url: 'index.php/procesos/fondo',
    idField:'id_f',
    textField:'id_f',
    mode:'remote',
    fitColumns:true,
 ...
 {field:'id_pr',title:'ID',width:60},
  {field:'nombre',title:'Nombre',width:120},
   {field:'codigo',title:'Codigo',width:60}
	 ...
	 onSelect:function(){
		 var g = jQuery('.uni').combogrid('grid');	// get datagrid object
		 var r = g.datagrid('getSelected');	// get the selected row
         jQuery('#epr').val(r.id_pr);
    }
    });
jQuery('.fon').combogrid({
    panelWidth:500,
    url: 'index.php/procesos/fondo',
    idField:'id_f',
    textField:'id_f',
