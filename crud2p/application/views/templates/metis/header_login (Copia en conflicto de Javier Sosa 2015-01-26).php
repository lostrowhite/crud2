    ...
    <div class="form-signin">
      ...
      <div class="tab-content">
        <div id="login" class="tab-pane active">
          <form class="form-signin" role="form" action="<?php echo base_url(); ?>session/login" method="post" id="doLog">
            ...
            <div class="alert alert-danger text-center" role="alert" style="margin-top:35px;margin-bottom:-20px;display:none;">
        ...
        <div id="forgot" class="tab-pane">
          <!-- <form action="index.html"> -->
            ...
            <input type="email" placeholder="correo@ejemplo.com" class="form-control text-center">
            <br>
