...
<body class="  ">
    <div class="bg-dark dk" id="wrap" style="min-height: 629px;">
          ...
          <div class="container-fluid">
            ...
            <header class="navbar-header">
              ...
              <a href="inicio" class="navbar-brand">
                <img class="media-object img-thumbnail user-img" alt="User Picture" src="images/ucv.gif" style="width:50px;height:50px;">
              </a> 
            </header>
            <div class="topnav">
              <!-- <div class="btn-group">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
              ...
              <!-- .nav -->
                <span style="color: rgba(0, 183, 75, 0.9);font-size: xx-large;margin-left: 20px;">Sistema Integrado De Gestión. SIG-DEU</span>
              <!-- /.nav -->
            </div>
          </div><!-- /.container-fluid -->
        </nav><!-- /.navbar -->
      ...
      <div id="left">
            ...
            <div class="media-body">
              ...
              <ul class="list-unstyled user-info">
                ...
                <li>Última visita:
                  <br>
                  <small>
                    <i class="fa fa-calendar"></i>&nbsp; <?php echo date('j, M Y h:m', strtotime($this->session->userdata('ult_sesion'))) ?></small>
                </li>
              </ul>
            </div>
          </div>
        ...
        <ul id="menu" class="bg-blue dker" style="min-height: 17px;margin-bottom:100px;">
        ...
        <?php foreach($menu as $menuTop): ?>
          ...
          <?php foreach($menuTop['menu_secundario'] as $menuBottom): ?>
              <li class="loadToContainer" id="<?php echo base_url().$menuBottom->controller?>" name="<?php echo $menuBottom->controller?>">
                <a href="javascript:;">
      ...
      <div id="content" style="padding: 0 !important;margin-bottom: 6%;">
        ...
        <!-- Container -->
          <div class="inner bg-light lter container" style="width: 100%;padding: 0;">
            <?php //$this->load->view('index/calendar'); ?>
            <div class="col-lg-12">
            </div>
          </div><!-- /.inner -->
        </div><!-- /.outer -->
    ...
    <script src='assets/lib/fullcalendar-2.3.1/lib/jquery.min.js'></script>
    ...
    <script src='assets/lib/fullcalendar-2.3.1/lib/moment.min.js'></script>
    <script src='assets/lib/fullcalendar-2.3.1/fullcalendar.js'></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $('.loadToContainer').click(function(e){
          ...
          $('.container').load($(this).attr('id'),{controller:$(this).attr('name'),id_user:id});
          ...
          $(document).attr('title', ':: SIG-DEU :: ' + $(this).children().html().toString().replace('<i class="fa fa-angle-right"></i>', '').replace('&nbsp;',''));
        });
