   ...
   <script type="text/javascript">
	jQuery(document).ready(function(){
	 jQuery("#add").click(function(){
                ...
                var datos=jQuery('#form1').serialize();
  	 ...
  	 jQuery.ajax({url:"usuarios/adduser",type:'POST',data:{
  	 	...
  	 	success:function(result){
  	 		...
  	 		if(result==3)
				Xcrud.show_message('.xcrud-ajax','Correo ya registrado!','error')   
            ...
            if(result==1){
            	...
            	function(data){
            		if(data.indexOf('sent') != -1)
                  		Xcrud.show_message('.xcrud-ajax','Usuario Creado Correctamente! Su contraseña se ha enviado a su correo.','success');
                    else
                  		Xcrud.show_message('.xcrud-ajax','Usuario Creado Correctamente! No se pudo enviar la contraseña.','success');
            		$('#form1').css('opacity', '1');
            	});
            }
