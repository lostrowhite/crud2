...
define('XCRUDWIN',str_replace('/xcrud', '', XCRUD_PATH));
...
class Xcrud
{
    ...
    public static function get_requested_instance()
    {
        ...
        if (isset($_SESSION['xcrud_session'][$inst_name]['key']) && $_SESSION['xcrud_session'][$inst_name]['key'] == $key)
        {
			...
			if ($_POST['xcrud']['task']=='print'){
				self::$instance[$inst_name]->is_csv=false;
				self::$instance[$inst_name]->is_create=false;
				self::$instance[$inst_name]->is_print='imprime';
			}
    ...
    protected function _render_list()
    {
        ...
        $mode = 'list';
        $view_file = XCRUDWIN .  '/views/xcrud/' . $this->load_view[$mode];
    ...
    public static function load_css()
    {
        ...
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<link href="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/jquery-ui/multi-select.css" rel="stylesheet" type="text/css" />';
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<link href="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/jquery-ui/jquery.selectBox.css" rel="stylesheet" type="text/css" />';
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<link href="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/jquery-ui/easyui.css" rel="stylesheet" type="text/css" />';
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<link href="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/select2/select2.css" rel="stylesheet" type="text/css" />';
    ...
    public static function load_js()
    {
        ...
        if (Xcrud_config::$load_jquery_easy_ui)            
            $out .= '<script src="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/jquery-ui/jquery.easyui.min.js"></script>';
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<script src="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/jquery-ui/jquery.multi-select.js"></script>';
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<script src="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
                '/jquery-ui/jquery.selectBox.js"></script>';
        if (Xcrud_config::$load_jquery_ui)
            $out .= '<script src="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
