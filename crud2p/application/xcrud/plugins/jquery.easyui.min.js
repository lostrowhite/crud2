...
},beforePageText:"Página",afterPageText:"de {pages}",displayMsg:"Mostrando {from} - {to} de {total} registros",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"Este campo es requerido.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
t.find("td[abbr=\""+_491+"\"]").addClass("calendar-Hoy");
if(opts.current){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:1,weeks:["D","L","M","M","J","V","S"],months:["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov","Dic"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_49a){
...
_8de(this,q);
}},currentText:"Hoy",closeText:"Cerrar",okText:"Ok",buttons:[{text:function(_8ef){
