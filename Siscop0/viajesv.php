  ...
  <div id="header1">
    ...
    <tr>
      ...
      <td width="324" id="direccion21">Correo:<br />
        <input name="c_correo" type="text" class="validate[required,custom[email]] text-input" value="<?php echo $cliente['correo']?>" size="30" readonly="readonly"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td "telefono"> Teléfono:<br />
        ...
        <input name="c_cantidad" type="text" class="validate[required,custom[onlyNumberSp]] text-input" id="c_cantidad" value="<?php echo $cliente['cantidad']?>" size="5" maxlength="13" readonly="readonly"/></td>
      <td id="direccion19">Lugar de Destino:<br />
        <input name="c_telefono2" type="text" class="validate[required] text-input" onkeyup="mascara(this,'-',tlf,true)" value="<?php echo $cliente['lugar'];}}?>" maxlength="13" readonly="readonly"/></td>
    </tr>
        <tr>
          <td align="center" colspan="2">Respuesta
            <br />
            <textarea name="respuesta" cols="80" rows="5" readonly="readonly" id="respuesta"><?php echo $cliente['respuesta']?></textarea></td>
        </tr>
        <tr id="izq">
          <td id="der" colspan="2" align="center"></td>
        </tr>
  </table>
