...
if(isset($_GET['id_s'])){
		...
		$consulta = $objCliente->edita_socios($_GET['id_s']);
...
<!-- HEADER -->
  <div id="header1">
    ...
    <header id="titulo">
        ...
        <h3>Ficha Informativa de Socios</h3>
    </header>
	<form id="form1" method="post" action="acsocio.php" >
 <table width="894" border="1" bordercolor="#0f56ba" align="center">
    <tr>
      <td align="center" colspan="4"><input type="hidden" name="socio_id" id="socio_id" value="<?php echo $cliente['id_s']?>" />
    ...
    <tr>
      <td>Apellidos</td>
      <td>
        <input name="c_apellidos" type="text" onfocus="this.blur()" value="<?php echo $cliente['apellido']?>" readonly="readonly" /></td>
      <td>Beneficiario: </td>
    ...
    <tr>
      <td>Cédula</td>
      <td>
  <select name="c_nacionalidad" id="c_nacionalidad" disabled="disabled" >
    ...
    <?php
      ...
      <td>N° Licencia: </td>
      <td><input name="c_nlicencia" type="text" id="c_nlicencia" value="<?php echo $cliente['nlic']?>" size="3" readonly="readonly" /></td>
      </tr>
    <tr>
      <td>Vencimiento C.I: </td>
      <td>
        <input name="c_vcedula" type="text" class="validate[required,custom[date]] text-input" value="<?php echo $cliente['venci']?>" id="c_vcedula" size="10" readonly="readonly" />
    ...
    <tr>
      <td>Ingreso: </td>
      <td>
        <input name="c_ingreso" type="text" class="validate[required,custom[date]] text-input" id="c_ingreso" value="<?php echo $cliente['ingreso']?>" size="10" readonly="readonly" />
    ...
    <tr>
      <td>Teléfono: </td>
      <td>
        <input name="c_telefono" type="text" class="validate[required,custom[onlyNumberSp]] text-input" value="<?php echo $cliente['tlf']?>" readonly="readonly" />
</td>
      <td>Cuenta: </td>
    ...
    <tr>
      <td>F Nacimiento</td>
      <td>
        <input name="c_nacimiento" type="text" class="validate[required,custom[date]] text-input" id="c_nacimiento" onfocus="this.blur()" size="10" readonly="readonly" value="<?php echo $cliente['nacimiento']?>" />
    ...
    <tr>
      ...
      <td><input name="c_gruposanguinieo" type="text" value="<?php echo $cliente['gruposang']?>" size="3" readonly="readonly" /></td>
      </tr>
    <tr>
      <td>Estado Civil:</td>
      ...
      <td>Correo:</td>
      <td><input name="c_correo" type="text" value="<?php echo $cliente['correo']?>" size="30" readonly="readonly" /></td>
      </tr>
    <tr>
      <td>Carga Familiar:</td>
      <td><input name="c_cfamiliar" type="text" value="<?php echo $cliente['cargafam']?>" size="2" readonly="readonly" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2">Dirección:</td>
      <td colspan="2"><textarea name="c_direccion" cols="40" rows="2" readonly="readonly"><?php echo $cliente['direccion']?></textarea></td>
    </tr>
    <tr>
      <td colspan="2">Historia:</td>
      <td colspan="2"><textarea name="c_historia" cols="40" rows="2" readonly="readonly"><?php echo $cliente['historia']?></textarea></td>
    </tr>
  </table> 
</form>
</div>
