...
jQuery(document).ready(function(){
	 var fechai = document.getElementById('fechaida').value;
		 $( "#fechaida" ).keyup(function() {
alert(fechai);
});
...
<!-- HEADER -->
  <div id="header1">
    ...
    <tr id="sizq" >
      <td colspan="2" align="center" class="sder" ><h3>Solicitar Servicio de Viaje</h3></td>
    </tr>
    <tr>
    ...
    <tr>
	 ...
	 var fecha = new Date();
       var anio = fecha.getYear()+1900;
			  ...
			  var dia = $("#fechaida").val();
	var ida = Calendar.setup({
        trigger    : "vced",
		dateFormat: "%d-%m-%Y",
        inputField : "fechaida",
		onSelect   : function() { 
		 var date = Calendar.intToDate(this.selection.get());
           vuelta.args.min = date;
           vuelta.redraw();
		this.hide()
		 },
    });
...
*</td>
    ...
    <tr>
      ...
      <select name="estados" id="estados" class="validate[required]">
