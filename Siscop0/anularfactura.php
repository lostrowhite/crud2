...
$ev="12.3";
$detalle="Anulada factura de venta idfactura N: $usuario_id";

//Anula Factura
$sql = ("UPDATE facturav set estado='1' WHERE id_fv='".$usuario_id."'") or die ("Problemas en anular la factura:".mysql_error()) ; 

//Buscar detalles de factura a revertir 
$sql2 =("SELECT * FROM dfacturav WHERE id_fv='".$usuario_id."'") or die ("Problemas en buscar detalles de factura:".mysql_error());
...
$sql3= ("UPDATE repuestos SET cantidad=cantidad+ '".$cliente['cantidad']."' WHERE id_r= '".$cliente['id_r']."'")or die("Problemas en revertir cambios".mysql_error);
	...
	echo "Anulada la factura de venta correctamente";
	';
	}
else {
echo "Error al anular la factura de venta: Contacte al administrador del sistema";
