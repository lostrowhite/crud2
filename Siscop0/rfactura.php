...
//DATOS DEL LADO DERECHO
	...
	$pdf->Cell(0,6,'Fecha de creación: '.date("d-m-Y",strtotime($_GET['c_fechaf'])),0,1);
	$pdf->Cell(0,6,'Nombre del Socio: '.$nombresocio['nombre']." ".$nombresocio['apellido'],0,1);
