...
<input name="c_nsocio" type="text" id="c_nsocio" value="<?php echo $cliente['id_s']?>" size="6" readonly="readonly" /></td>
    ...
    <tr>
      <td>Nombres</td>
      <td><input name="c_nombres" type="text" class="validate[required] text-input" value="<?php echo $cliente2['nombre']?>" readonly="readonly" /></td>
      <td>Fecha: </td>
      <td id="fdeposito"><input name="c_fecha" type="text"class="validate[required] fecha " id="c_fecha" value="<?php echo date('d-m-Y',strtotime( $cliente['fecha']))?>" readonly="readonly"/>  <img src="images/calendario.png" id="fdep" alt="" width="16" height="16" /><script>
    Calendar.setup({
        trigger    : "fdep",
		dateFormat: "%d-%m-%Y",
        inputField : "c_fecha",
...
?>
      ...
      <input name="mesa" type="text" id="mesa" value="<?php echo $meses[date("m",strtotime($cliente['mes']))-1];?>" size="10" readonly="readonly" />
        Año:
        <input name='anoa' type='text' id='anoa' value="<?php echo date("Y",strtotime($cliente['mes']));?>" size='6' readonly='readonly' /></td>
      </tr>
    <tr>
      <td>Apellidos</td>
      <td><input name="c_apellidos" type="text" class="validate[required] text-input" value="<?php echo $cliente2['apellido']?>" readonly="readonly" /></td>
      <td>Banco:</td>
    ...
    <tr>
      <td>Cédula</td>
      <td><input name="c_cedula" type="text" value="<?php echo $cliente2['cedula']?>" readonly="readonly"/></td>
      <td>Monto</td>
