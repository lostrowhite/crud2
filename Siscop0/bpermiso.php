	...
	$("#nuevopermiso").click(function(){
		...
		$.ajax({
			...
			success: function(datos){
				$("#datos").html(datos);
				$("#gestionapermiso").removeClass("active");	
				$("#nuevopermiso").addClass("active");
			}
		});
		return false;
		});
$("#gestionapermiso").click(function(){
		$('#contenido').show();
		$("#datos").hide();
		$("#gestionapermiso").addClass("active");	
		$("#nuevopermiso").removeClass("active");
				return false;
		});
...
<!-- HEADER -->
   <div id="header1">
		<div class="row-2">
			<div class="left">
				<ul>
					<li><a id="gestionapermiso" href="" class="active"><span>GESTIONAR PERMISOS</span></a></li>
					<li><a id="nuevopermiso" href=""><span>NUEVO PERMISO</span></a></li>
				</ul>
			</div>
		</div>
</div>
