...
<form id="form1"  method="post" action="recuperacom.php" onSubmit="if(!confirm('Esta seguro que ingreso la respuesta correcta?')){return false;}" >
    ...
    <tr id="sizq" >
      <td align="center" class="sder" ><h3>Recuperación de contraseña</h3></td>
    </tr>
    <tr>
      <td align="center" id="cedula" class="cedula">Nombre:<br />
        ...
        <br />
        Constraseña Nueva<br />
        <input name="pass" type="password" size="30" class="validate[required]" id="pass"/>
        <br />
        Repita Contraseña<br />
        <input name="pass2" type="password" size="30" class="validate[required]" id="pass2"/></td>
    </tr>
    <tr id="izq">
      ...
      <dt><dl><input name="Procesar" value="Procesar" type="button" onclick="compruebapw();" /></dl></dt>
        </div></td>
    </tr>
  </table>
